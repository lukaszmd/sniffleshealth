...
function AIMessage({ text }: { text: string }) {
  return (
    <div className="flex items-start gap-3">
      <div className="w-8 h-8 rounded-full bg-[#DCE9EB] flex items-center justify-center flex-shrink-0 mt-2">
        <svg
          width="16"
          height="16"
          viewBox="0 0 32 32"
      ...
      <div className="flex flex-col gap-1 flex-1">
        <span
          className="text-[#292524] text-xs"
          style={{
            fontFamily: "Inter, -apple-system, sans-serif",
            lineHeight: "16px",
          }}
        >
          Sniffles Health Assitant
        </span>
        <div className="bg-[#ECF3F4] rounded-bl-[30px] rounded-br-[30px] rounded-tl-[12px] rounded-tr-[30px] px-3 py-5">
          <p
            className="text-[#1C1917] text-base"
            style={{
              fontFamily: "Inter, -apple-system, sans-serif",
...
function UserMessage({ text }: { text: string }) {
  return (
    <div className="flex flex-col items-end gap-1">
      ...
      <div className="bg-[#3E5E6A] rounded-bl-[30px] rounded-br-[24px] rounded-tl-[30px] rounded-tr-[12px] px-5 py-5 min-h-[44px] flex items-center">
        <p
